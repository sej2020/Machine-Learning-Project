...
def comparison(id: int, which_regressors: dict, metric_list: list, styledict: dict, n_vizualized_bp: int, n_vizualized_tb: int, test_set_size: float, n_cv_folds: int, score_method: str, datapath: str, n_workers: int) -> list:
    """
