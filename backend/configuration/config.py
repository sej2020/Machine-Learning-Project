...
class Settings:
    ...
    TEMP_UPLOAD_DIR = os.getenv('TEMP_UPLOAD_DIR') or f'/home/madhavan/python-workspace/Machine-Learning-Project/backend/uploads'
    TEMP_DOWNLOAD_DIR = os.getenv('TEMP_DOWNLOAD_DIR') or f'/home/madhavan/python-workspace/Machine-Learning-Project/backend/downloads'
    ...
    HOST = os.getenv('HOST') or 'http://localhost:8081'
